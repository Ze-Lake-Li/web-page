...
// Update navigation link for CV
const cvLink = document.querySelector('.sidebar-links a[href="#cv"]');
if (cvLink) {
    cvLink.setAttribute('href', '#cv');
    cvLink.innerHTML = '<span class="icon">📄</span> CV';
}
...
if (isMobile) {
    // Disable wheel scroll navigation
